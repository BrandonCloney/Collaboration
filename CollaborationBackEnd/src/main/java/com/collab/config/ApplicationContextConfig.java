...
import org.springframework.web.servlet.view.InternalResourceViewResolver;
	...
	public class ApplicationContextConfig {
		...
		public SessionFactory getSessionFactory(DataSource datasource) {
			...
			sessionBuilder.addAnnotatedClass(com.collab.model.User.class);
			//sessionBuilder.addAnnotatedClass(com.collab.model.Comment.class);
			//sessionBuilder.addAnnotatedClass(com.collabo.model.Blog.class);
